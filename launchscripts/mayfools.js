console.log('Launching... launch script v 3.5.2');
...
async function loadGames() {
    ...
    const clientHtml = await fetch("https://president-of-the-math-team.com/client/mayfools.html").then(res => res.text()).catch(err => console.error(err));
    ...
    gameIDs.forEach(game => {
        ...
        var gamecard = createGameCard("Crazy Cattle 3D", game.elementId, game.id, "crazycattle3dtitlecard.png", "https://crazycattle3dgame.io/crazy-cattle-3d.embed", false, false, false);
