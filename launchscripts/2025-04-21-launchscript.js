console.log('Launching... launch script v 3.5.1');
...
async function loadGames() {
    ...
    const clientHtml = await fetch("https://president-of-the-math-team.com/client/v351.html").then(res => res.text()).catch(err => console.error(err));
